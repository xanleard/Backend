...
namespace MatriculaWebApplicationEF.Migrations
{
    ...
    [Migration("20201216152001_migracionPaiseHacer")]
    partial class migracionPaiseHacer
    {
            ...
            modelBuilder.Entity("MatriculaWebApplicationEF.Models.Estudiante", b =>
                {
                    ...
                    b.HasIndex("PaisHacerId");

                    b.ToTable("Estudiantes","dbo");
                });

            modelBuilder.Entity("MatriculaWebApplicationEF.Models.PaisHacer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MatriculaWebApplicationEF.Models.Estudiante", b =>
                {
                    ...
                    b.HasOne("MatriculaWebApplicationEF.Models.PaisHacer", "PaisHacer")
                        .WithMany("Estudiantes")
                        .HasForeignKey("PaisHacerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
